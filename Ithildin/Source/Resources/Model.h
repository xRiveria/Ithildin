...
namespace Resources
{
    ...
    public:
        ...
        static Model CreateBox(const glm::vec3& point0, const glm::vec3& point1, const Material& material);
        ...
        const Procedural* GetProcedural() const { return m_Procedural.get(); }
    ...
    private:
        ...
        std::shared_ptr<const Procedural> m_Procedural;
    };
}